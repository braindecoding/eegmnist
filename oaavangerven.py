...
# In[]: Load dataset: X stimulus, Y fMRI/EEG
resolution = 28

X_train, X_test, X_validation, Y_train, Y_test, Y_validation=prepro.getXYValeeg('eeg_combined_by_event_fixed_length.parquet',resolution)
